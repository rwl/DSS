...
class Seal(IdentifiedObject):
    ...
    def set_asset_container(self, value):
        ...
        if self._asset_container is not None:
            if self not in self._asset_container._seals:
...
class Asset(IdentifiedObject):
    ...
    # <<< asset
    # @generated
    def __init__(self, purchase_price=0.0, application='', initial_loss_of_life=0.0, initial_condition='', corporate_code='', installation_date='', manufactured_date='', category='', utc_number='', critical=False, lot_number='', serial_number='', acceptance_test=None, status=None, to_asset_roles=None, erp_rec_delivery_items=None, asset_functions=None, electronic_addresses=None, dimensions_info=None, erp_item_master=None, properties=None, erp_inventory=None, scheduled_events=None, change_items=None, ratings=None, asset_container=None, work_task=None, document_roles=None, from_asset_roles=None, financial_info=None, asset_property_curves=None, erp_organisation_roles=None, measurements=None, hazards=None, mediums=None, reliability_infos=None, location_roles=None, power_system_resource_roles=None, activity_records=None, **kw_args):
    ...
    def add_to_asset_roles(self, *to_asset_roles):
        for obj in to_asset_roles:
            ...
            if obj not in self._to_asset_roles:
    ...
    def set_dimensions_info(self, value):
        ...
        if self._dimensions_info is not None:
            if self not in self._dimensions_info._assets:
    ...
    def set_asset_container(self, value):
        ...
        self._asset_container = value
        if self._asset_container is not None:
            if self not in self._asset_container._assets:
    ...
    def set_work_task(self, value):
        ...
        if self._work_task is not None:
            if self not in self._work_task._assets:
    ...
    def add_from_asset_roles(self, *from_asset_roles):
        for obj in from_asset_roles:
            obj._to_asset = self
            if obj not in self._from_asset_roles:
...
class ElectricalInfo(IdentifiedObject):
    ...
    # <<< electrical_info
    # @generated
    def __init__(self, g0=0.0, x=0.0, r0=0.0, wire_count=0, x0=0.0, rated_voltage=0.0, g=0.0, b0=0.0, b=0.0, rated_apparent_power=0.0, r=0.0, phase_count=0, bil=0.0, rated_current=0.0, frequency=0.0, end_device_assets=None, electrical_assets=None, electrical_asset_model_roles=None, electrical_type_asset_roles=None, **kw_args):
        ...
        if electrical_asset_model_roles is None:
            self.electrical_asset_model_roles = []
        else:
            self.electrical_asset_model_roles = electrical_asset_model_roles
        self._electrical_type_asset_roles = []
        if electrical_type_asset_roles is None:
            self.electrical_type_asset_roles = []
        else:
    ...
    def set_electrical_asset_model_roles(self, value):
        for x in self._electrical_asset_model_roles:
            x.electrical_info = None
        for y in value:
            y.electrical_info = self
    ...
    def add_electrical_asset_model_roles(self, *electrical_asset_model_roles):
        for obj in electrical_asset_model_roles:
            ...
            if obj not in self._electrical_asset_model_roles:
    ...
    def add_electrical_type_asset_roles(self, *electrical_type_asset_roles):
        for obj in electrical_type_asset_roles:
            obj._electrical_info = self
            if obj not in self._electrical_type_asset_roles:
...
class AssetContainer(Asset):
    ...
    # <<< asset_container
    # @generated
    def __init__(self, seals=None, land_properties=None, assets=None, **kw_args):
    ...
    def set_seals(self, value):
        for x in self._seals:
            x.asset_container = None
        for y in value:
            y.asset_container = self
        self._seals = value
...
class AssetFunction(Asset):
    ...
    def set_asset(self, value):
        ...
        self._asset = value
        if self._asset is not None:
            if self not in self._asset._asset_functions:
    ...
    def set_asset_function_asset_model(self, value):
        ...
        if self._asset_function_asset_model is not None:
            if self not in self._asset_function_asset_model._asset_functions:
