...
class MeterServiceWork(Work):
    ...
    def set_old_meter_asset(self, value):
        ...
        if self._old_meter_asset is not None:
            if self not in self._old_meter_asset._meter_replacement_works:
    ...
    def set_meter_asset(self, value):
        ...
        if self._meter_asset is not None:
            if self not in self._meter_asset._meter_service_works:
...
class IntervalBlock(Element):
    ...
    # <<< interval_block
    # @generated
    def __init__(self, meter_reading=None, pending=None, reading_type=None, interval_readings=None, **kw_args):
    ...
    def set_meter_reading(self, value):
        ...
        if self._meter_reading is not None:
            if self not in self._meter_reading._interval_blocks:
    ...
    def set_pending(self, value):
        ...
        self._pending = value
        if self._pending is not None:
            if self not in self._pending._interval_blocks:
    ...
    def set_reading_type(self, value):
        ...
        if self._reading_type is not None:
            if self not in self._reading_type._interval_blocks:
...
class ReadingQuality(Element):
    ...
    def set_interval_reading(self, value):
        ...
        if self._interval_reading is not None:
            if self not in self._interval_reading._reading_qualities:
    ...
    def set_reading(self, value):
        ...
        self._reading = value
        if self._reading is not None:
            if self not in self._reading._reading_qualities:
...
class EndDeviceGroup(IdentifiedObject):
    ...
    # <<< end_device_group
    # @generated
    def __init__(self, group_address=0, end_device_assets=None, end_device_controls=None, demand_response_program=None, **kw_args):
    ...
    def set_end_device_controls(self, value):
        for x in self._end_device_controls:
            x.end_device_group = None
        for y in value:
            y.end_device_group = self
    ...
    def set_demand_response_program(self, value):
        ...
        if self._demand_response_program is not None:
            if self not in self._demand_response_program._end_device_groups:
...
class Register(IdentifiedObject):
    ...
    def set_device_function(self, value):
        ...
        if self._device_function is not None:
            if self not in self._device_function._registers:
...
class ServiceDeliveryPoint(IdentifiedObject):
    ...
    # @generated
    def __init__(self, service_delivery_remark='', rated_current=0.0, rated_power=0.0, nominal_service_voltage=0, budget_bill='', estimated_load=0.0, load_mgmt='', phase_config='two_phase_two_wire', check_billing=False, billing_cycle='', grounded=False, consumption_real_energy=0.0, service_priority='', ctpt_reference=0, meter_readings=None, sdplocations=None, service_category=None, service_location=None, service_supplier=None, pricing_structures=None, end_device_assets=None, power_quality_pricings=None, customer_agreement=None, energy_consumer=None, **kw_args):
    ...
    def set_meter_readings(self, value):
        for x in self._meter_readings:
            x.service_delivery_point = None
        for y in value:
            y.service_delivery_point = self
    ...
    def set_service_category(self, value):
        ...
        if self._service_category is not None:
            if self not in self._service_category._service_delivery_points:
    ...
    def set_service_location(self, value):
        ...
        if self._service_location is not None:
            if self not in self._service_location._service_delivery_points:
    ...
    def set_service_supplier(self, value):
        ...
        if self._service_supplier is not None:
            if self not in self._service_supplier._service_delivery_points:
    ...
    def set_customer_agreement(self, value):
        ...
        if self._customer_agreement is not None:
            if self not in self._customer_agreement._service_delivery_points:
    ...
    def set_energy_consumer(self, value):
        ...
        if self._energy_consumer is not None:
            if self not in self._energy_consumer._service_delivery_points:
...
class MeterReading(IdentifiedObject):
    ...
    # <<< meter_reading
    # @generated
    def __init__(self, values_interval=None, service_delivery_point=None, customer_agreement=None, readings=None, interval_blocks=None, end_device_events=None, meter_asset=None, **kw_args):
    ...
    def set_service_delivery_point(self, value):
        ...
        if self._service_delivery_point is not None:
            if self not in self._service_delivery_point._meter_readings:
    ...
    def set_customer_agreement(self, value):
        ...
        self._customer_agreement = value
        if self._customer_agreement is not None:
            if self not in self._customer_agreement._meter_readings:
    ...
    def set_interval_blocks(self, value):
        for x in self._interval_blocks:
            x.meter_reading = None
        for y in value:
            y.meter_reading = self
    ...
    def add_interval_blocks(self, *interval_blocks):
        for obj in interval_blocks:
            ...
            if obj not in self._interval_blocks:
    ...
    def add_end_device_events(self, *end_device_events):
        for obj in end_device_events:
            obj._meter_reading = self
            if obj not in self._end_device_events:
    ...
    def set_meter_asset(self, value):
        ...
        self._meter_asset = value
        if self._meter_asset is not None:
            if self not in self._meter_asset._meter_readings:
...
class EndDeviceControl(IdentifiedObject):
    ...
    # <<< end_device_control
    # @generated
    def __init__(self, type='', dr_program_level=0, dr_program_mandatory=False, price_signal=0.0, scheduled_interval=None, demand_response_program=None, customer_agreement=None, end_device_asset=None, end_device_group=None, **kw_args):
    ...
    def set_demand_response_program(self, value):
        ...
        self._demand_response_program = value
        if self._demand_response_program is not None:
            if self not in self._demand_response_program._end_device_controls:
    ...
    def set_customer_agreement(self, value):
        ...
        self._customer_agreement = value
        if self._customer_agreement is not None:
            if self not in self._customer_agreement._end_device_controls:
    ...
    def set_end_device_asset(self, value):
        ...
        if self._end_device_asset is not None:
            if self not in self._end_device_asset._end_device_controls:
    ...
    def set_end_device_group(self, value):
        ...
        if self._end_device_group is not None:
            if self not in self._end_device_group._end_device_controls:
...
class ReadingType(IdentifiedObject):
    ...
    # <<< reading_type
    # @generated
    def __init__(self, channel_number=0, unit='_c', reverse_chronology=False, dynamic_configuration='', multiplier='micro', interval_length=0.0, default_value_data_type='', kind='other', default_quality='', interval_blocks=None, pending=None, readings=None, register=None, **kw_args):
...
class EndDeviceEvent(ActivityRecord):
    ...
    def set_device_function(self, value):
        ...
        self._device_function = value
        if self._device_function is not None:
            if self not in self._device_function._end_device_events:
    ...
    def set_meter_reading(self, value):
        ...
        self._meter_reading = value
        if self._meter_reading is not None:
            if self not in self._meter_reading._end_device_events:
...
class SDPLocation(Location):
    ...
    # <<< sdplocation
    # @generated
    def __init__(self, access_method='', site_access_problem='', occupancy_date='', remark='', service_delivery_points=None, **kw_args):
...
class Pending(Element):
    ...
    # <<< pending
    # @generated
    def __init__(self, offset=0, scalar_float=0.0, scalar_numerator=0, multiply_before_add=False, scalar_denominator=0, reading_type=None, interval_blocks=None, **kw_args):
...
class DeviceFunction(AssetFunction):
    ...
    # <<< device_function
    # @generated
    def __init__(self, disabled=False, end_device_asset=None, com_equipment_asset=None, registers=None, end_device_events=None, **kw_args):
    ...
    def set_end_device_asset(self, value):
        ...
        self._end_device_asset = value
        if self._end_device_asset is not None:
            if self not in self._end_device_asset._device_functions:
    ...
    def set_com_equipment_asset(self, value):
        ...
        if self._com_equipment_asset is not None:
            if self not in self._com_equipment_asset._device_functions:
    ...
    def set_registers(self, value):
        for x in self._registers:
            x.device_function = None
        for y in value:
            y.device_function = self
...
class Reading(MeasurementValue):
    ...
    # <<< reading
    # @generated
    def __init__(self, value=0.0, reading_type=None, meter_readings=None, reading_qualities=None, end_device_asset=None, **kw_args):
    ...
    def set_reading_type(self, value):
        ...
        self._reading_type = value
        if self._reading_type is not None:
            if self not in self._reading_type._readings:
    ...
    def add_reading_qualities(self, *reading_qualities):
        for obj in reading_qualities:
            obj._reading = self
            if obj not in self._reading_qualities:
    ...
    def set_end_device_asset(self, value):
        ...
        self._end_device_asset = value
        if self._end_device_asset is not None:
            if self not in self._end_device_asset._readings:
...
class EndDeviceAsset(AssetContainer):
    ...
    # <<< end_device_asset
    # @generated
    def __init__(self, outage_report=False, load_control=False, reverse_flow_handling=False, metrology=False, time_zone_offset=0.0, amr_system='', dst_enabled=False, read_request=False, demand_response=False, disconnect=False, relay_capable=False, electrical_infos=None, customer=None, device_functions=None, end_device_groups=None, end_device_model=None, end_device_controls=None, readings=None, service_location=None, service_delivery_point=None, **kw_args):
    ...
    def set_customer(self, value):
        ...
        if self._customer is not None:
            if self not in self._customer._end_device_assets:
    ...
    def set_device_functions(self, value):
        for x in self._device_functions:
            x.end_device_asset = None
        for y in value:
            y.end_device_asset = self
    ...
    def set_end_device_model(self, value):
        ...
        if self._end_device_model is not None:
            if self not in self._end_device_model._end_device_assets:
    ...
    def set_service_location(self, value):
        ...
        self._service_location = value
        if self._service_location is not None:
            if self not in self._service_location._end_device_assets:
    ...
    def set_service_delivery_point(self, value):
        ...
        self._service_delivery_point = value
        if self._service_delivery_point is not None:
            if self not in self._service_delivery_point._end_device_assets:
...
class IntervalReading(MeasurementValue):
    ...
    # <<< interval_reading
    # @generated
    def __init__(self, value=0.0, reading_qualities=None, interval_blocks=None, **kw_args):
    ...
    def set_reading_qualities(self, value):
        for x in self._reading_qualities:
            x.interval_reading = None
        for y in value:
            y.interval_reading = self
        self._reading_qualities = value
...
class DemandResponseProgram(IdentifiedObject):
    ...
    # <<< demand_response_program
    # @generated
    def __init__(self, type='', validity_interval=None, end_device_groups=None, end_device_controls=None, customer_agreements=None, **kw_args):
    ...
    def set_end_device_groups(self, value):
        for x in self._end_device_groups:
            x.demand_response_program = None
        for y in value:
            y.demand_response_program = self
        self._end_device_groups = value
    ...
    def add_end_device_groups(self, *end_device_groups):
        for obj in end_device_groups:
            ...
            if obj not in self._end_device_groups:
                self._end_device_groups.append(obj)
...
class ElectricMeteringFunction(DeviceFunction):
    ...
    # @generated
    def __init__(self, transformer_ctratio=0.0, billing_multiplier=0.0, transformer_ratios_applied=False, demand_multiplier=0.0, k_wh_multiplier=0, transformer_vtratio=0.0, billing_multiplier_applied=False, current_rating=0.0, voltage_rating=0.0, k_wmultiplier=0, demand_multiplier_applied=False, metering_function_configuration=None, **kw_args):
    ...
    def set_metering_function_configuration(self, value):
        ...
        if self._metering_function_configuration is not None:
            if self not in self._metering_function_configuration._electric_metering_functions:
...
class MeterAsset(EndDeviceAsset):
    ...
    # <<< meter_asset
    # @generated
    def __init__(self, k_h=0.0, form_number='', k_r=0.0, meter_service_works=None, meter_asset_model=None, meter_readings=None, vending_transactions=None, meter_replacement_works=None, **kw_args):
        ...
        if meter_service_works is None:
    ...
    def add_meter_service_works(self, *meter_service_works):
        for obj in meter_service_works:
            ...
            if obj not in self._meter_service_works:
    ...
    def set_meter_asset_model(self, value):
        ...
        if self._meter_asset_model is not None:
            if self not in self._meter_asset_model._meter_assets:
    ...
    def add_vending_transactions(self, *vending_transactions):
        for obj in vending_transactions:
            obj._meter_asset = self
            if obj not in self._vending_transactions:
    ...
    def set_meter_replacement_works(self, value):
        for x in self._meter_replacement_works:
            x.old_meter_asset = None
        for y in value:
            y.old_meter_asset = self
    ...
    def add_meter_replacement_works(self, *meter_replacement_works):
        for obj in meter_replacement_works:
            ...
            if obj not in self._meter_replacement_works:
