 ...
 * <ul>
 *   <li>{@link electrickery.control.impl.GeneratorDispatcherImpl#getElement <em>Element</em>}</li>
 *   <li>{@link electrickery.control.impl.GeneratorDispatcherImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link electrickery.control.impl.GeneratorDispatcherImpl#getKWLimit <em>KW Limit</em>}</li>
 *   <li>{@link electrickery.control.impl.GeneratorDispatcherImpl#getKWBand <em>KW Band</em>}</li>
 *   <li>{@link electrickery.control.impl.GeneratorDispatcherImpl#getKVarLimit <em>KVar Limit</em>}</li>
 *   <li>{@link electrickery.control.impl.GeneratorDispatcherImpl#getGenList <em>Gen List</em>}</li>
 *   <li>{@link electrickery.control.impl.GeneratorDispatcherImpl#getWeights <em>Weights</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
