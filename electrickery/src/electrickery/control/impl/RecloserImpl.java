 ...
 * <ul>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getMonitoredObj <em>Monitored Obj</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getMonitoredTerm <em>Monitored Term</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getSwitchedObj <em>Switched Obj</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getSwitchedTerm <em>Switched Term</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getNFast <em>NFast</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getPhaseFast <em>Phase Fast</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getPhaseDelayed <em>Phase Delayed</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getGroundFast <em>Ground Fast</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getGroundDelayed <em>Ground Delayed</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getPhaseTrip <em>Phase Trip</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getGroundTrip <em>Ground Trip</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getPhaseInst <em>Phase Inst</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getGroundInst <em>Ground Inst</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getReset <em>Reset</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getShots <em>Shots</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getRecloseIntervals <em>Reclose Intervals</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getAction <em>Action</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getTDPhFast <em>TD Ph Fast</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getTDGrFast <em>TD Gr Fast</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getTDPhDelayed <em>TD Ph Delayed</em>}</li>
 *   <li>{@link electrickery.control.impl.RecloserImpl#getTDGrDelayed <em>TD Gr Delayed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
