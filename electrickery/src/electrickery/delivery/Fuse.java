 ...
 * <ul>
 *   <li>{@link electrickery.delivery.Fuse#getMonitoredObj <em>Monitored Obj</em>}</li>
 *   <li>{@link electrickery.delivery.Fuse#getMonitorTerm <em>Monitor Term</em>}</li>
 *   <li>{@link electrickery.delivery.Fuse#getSwitchedObj <em>Switched Obj</em>}</li>
 *   <li>{@link electrickery.delivery.Fuse#getSwitchedTerm <em>Switched Term</em>}</li>
 *   <li>{@link electrickery.delivery.Fuse#getFuseCurve <em>Fuse Curve</em>}</li>
 *   <li>{@link electrickery.delivery.Fuse#getRatedCurrent <em>Rated Current</em>}</li>
 *   <li>{@link electrickery.delivery.Fuse#getDelay <em>Delay</em>}</li>
 *   <li>{@link electrickery.delivery.Fuse#getAction <em>Action</em>}</li>
 * </ul>
 * </p>
 *
 * @see electrickery.delivery.DeliveryPackage#getFuse()
 * @model
 * @generated
 */
public interface Fuse extends PowerDeliveryElement {
	 ...
	 * @see electrickery.delivery.DeliveryPackage#getFuse_MonitoredObj()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link electrickery.delivery.Fuse#getMonitoredObj <em>Monitored Obj</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see electrickery.delivery.DeliveryPackage#getFuse_MonitorTerm()
	 * @model default="1"
	 * @generated
	 */
	int getMonitorTerm();
	...
	/**
	 * Sets the value of the '{@link electrickery.delivery.Fuse#getMonitorTerm <em>Monitor Term</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see electrickery.delivery.DeliveryPackage#getFuse_SwitchedObj()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link electrickery.delivery.Fuse#getSwitchedObj <em>Switched Obj</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see electrickery.delivery.DeliveryPackage#getFuse_SwitchedTerm()
	 * @model default="1"
	 * @generated
	 */
	int getSwitchedTerm();
	...
	/**
	 * Sets the value of the '{@link electrickery.delivery.Fuse#getSwitchedTerm <em>Switched Term</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see electrickery.delivery.DeliveryPackage#getFuse_FuseCurve()
	 * @model
	 * @generated
	 */
	String getFuseCurve();
	...
	/**
	 * Sets the value of the '{@link electrickery.delivery.Fuse#getFuseCurve <em>Fuse Curve</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see electrickery.delivery.DeliveryPackage#getFuse_RatedCurrent()
	 * @model default="1.0"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link electrickery.delivery.Fuse#getRatedCurrent <em>Rated Current</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setDelay(double)
	 * @see electrickery.delivery.DeliveryPackage#getFuse_Delay()
	 * @model
	 * @generated
	 */
	double getDelay();
	...
	/**
	 * Sets the value of the '{@link electrickery.delivery.Fuse#getDelay <em>Delay</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see electrickery.delivery.DeliveryPackage#getFuse_Action()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link electrickery.delivery.Fuse#getAction <em>Action</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
