 ...
 *   <li>{@link electrickery.common.impl.CircuitElementImpl#isChecked <em>Checked</em>}</li>
 *   <li>{@link electrickery.common.impl.CircuitElementImpl#isHasMeter <em>Has Meter</em>}</li>
 *   <li>{@link electrickery.common.impl.CircuitElementImpl#isIsolated <em>Isolated</em>}</li>
 *   <li>{@link electrickery.common.impl.CircuitElementImpl#isHasControl <em>Has Control</em>}</li>
 *   <li>{@link electrickery.common.impl.CircuitElementImpl#isPartOfFeeder <em>Part Of Feeder</em>}</li>
 *   <li>{@link electrickery.common.impl.CircuitElementImpl#getControlElement <em>Control Element</em>}</li>
 ...
 *   <li>{@link electrickery.common.impl.CircuitElementImpl#getBusIndex <em>Bus Index</em>}</li>
