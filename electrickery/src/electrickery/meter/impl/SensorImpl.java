...
import electrickery.meter.sensorAction;
import electrickery.meter.sensorMode;
 ...
 * <ul>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getElement <em>Element</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getModes <em>Modes</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getV <em>V</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getI <em>I</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getP <em>P</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getQ <em>Q</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getPhases <em>Phases</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getConn <em>Conn</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getPctError <em>Pct Error</em>}</li>
 *   <li>{@link electrickery.meter.impl.SensorImpl#getAction <em>Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
