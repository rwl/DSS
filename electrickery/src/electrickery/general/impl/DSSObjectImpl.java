 ...
 * <ul>
 *   <li>{@link electrickery.general.impl.DSSObjectImpl#getDSSObjType <em>DSS Obj Type</em>}</li>
 *   <li>{@link electrickery.general.impl.DSSObjectImpl#getDSSClassName <em>DSS Class Name</em>}</li>
 *   <li>{@link electrickery.general.impl.DSSObjectImpl#getParentClass <em>Parent Class</em>}</li>
 *   <li>{@link electrickery.general.impl.DSSObjectImpl#getClassIndex <em>Class Index</em>}</li>
 *   <li>{@link electrickery.general.impl.DSSObjectImpl#isDirty <em>Dirty</em>}</li>
 *   <li>{@link electrickery.general.impl.DSSObjectImpl#isFlag <em>Flag</em>}</li>
 *   <li>{@link electrickery.general.impl.DSSObjectImpl#getPropSequence <em>Prop Sequence</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
