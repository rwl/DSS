 ...
 * <ul>
 *   <li>{@link dss.delivery.Fault#getBus1 <em>Bus1</em>}</li>
 *   <li>{@link dss.delivery.Fault#getBus2 <em>Bus2</em>}</li>
 *   <li>{@link dss.delivery.Fault#getR <em>R</em>}</li>
 *   <li>{@link dss.delivery.Fault#getPctStdDev <em>Pct Std Dev</em>}</li>
 *   <li>{@link dss.delivery.Fault#getGMatrix <em>GMatrix</em>}</li>
 *   <li>{@link dss.delivery.Fault#getOnTime <em>On Time</em>}</li>
 *   <li>{@link dss.delivery.Fault#isTemporary <em>Temporary</em>}</li>
 *   <li>{@link dss.delivery.Fault#getMinAmps <em>Min Amps</em>}</li>
 * </ul>
 * </p>
 *
 * @see dss.delivery.DeliveryPackage#getFault()
 * @model
 * @generated
 */
public interface Fault extends PowerDeliveryElement {
	 ...
	 * @see #setBus1(String)
	 * @see dss.delivery.DeliveryPackage#getFault_Bus1()
	 * @model
	 * @generated
	 */
	String getBus1();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Fault#getBus1 <em>Bus1</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setBus2(String)
	 * @see dss.delivery.DeliveryPackage#getFault_Bus2()
	 * @model
	 * @generated
	 */
	String getBus2();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Fault#getBus2 <em>Bus2</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setR(double)
	 * @see dss.delivery.DeliveryPackage#getFault_R()
	 * @model
	 * @generated
	 */
	double getR();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Fault#getR <em>R</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getFault_PctStdDev()
	 * @model
	 * @generated
	 */
	double getPctStdDev();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Fault#getPctStdDev <em>Pct Std Dev</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the value of the '<em><b>GMatrix</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>GMatrix</em>' attribute.
	 * @see #setGMatrix(DenseDoubleMatrix2D)
	 * @see dss.delivery.DeliveryPackage#getFault_GMatrix()
	 * @model dataType="dss.DenseDoubleMatrix2D"
	 * @generated
	 */
	DenseDoubleMatrix2D getGMatrix();

	/**
	 * Sets the value of the '{@link dss.delivery.Fault#getGMatrix <em>GMatrix</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>GMatrix</em>' attribute.
	 * @see #getGMatrix()
	 * @generated
	 */
	void setGMatrix(DenseDoubleMatrix2D value);
	 ...
	 * @see dss.delivery.DeliveryPackage#getFault_OnTime()
	 * @model
	 * @generated
	 */
	double getOnTime();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Fault#getOnTime <em>On Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getFault_Temporary()
	 * @model default="false"
	 * @generated
	 */
	boolean isTemporary();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Fault#isTemporary <em>Temporary</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getFault_MinAmps()
	 * @model default="5.0"
	 * @generated
	 */
	double getMinAmps();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Fault#getMinAmps <em>Min Amps</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
