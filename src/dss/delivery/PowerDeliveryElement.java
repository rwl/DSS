 ...
 * <ul>
 *   <li>{@link dss.delivery.PowerDeliveryElement#getNormAmps <em>Norm Amps</em>}</li>
 *   <li>{@link dss.delivery.PowerDeliveryElement#getEmergAmps <em>Emerg Amps</em>}</li>
 *   <li>{@link dss.delivery.PowerDeliveryElement#getFaultRate <em>Fault Rate</em>}</li>
 *   <li>{@link dss.delivery.PowerDeliveryElement#getPctPerm <em>Pct Perm</em>}</li>
 *   <li>{@link dss.delivery.PowerDeliveryElement#getRepair <em>Repair</em>}</li>
 * </ul>
 * </p>
 *
 * @see dss.delivery.DeliveryPackage#getPowerDeliveryElement()
 * @model abstract="true"
 * @generated
 */
public interface PowerDeliveryElement extends CircuitElement {
	 ...
	 * @see dss.delivery.DeliveryPackage#getPowerDeliveryElement_NormAmps()
	 * @model default="400.0"
	 * @generated
	 */
	double getNormAmps();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.PowerDeliveryElement#getNormAmps <em>Norm Amps</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getPowerDeliveryElement_EmergAmps()
	 * @model default="600.0"
	 * @generated
	 */
	double getEmergAmps();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.PowerDeliveryElement#getEmergAmps <em>Emerg Amps</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getPowerDeliveryElement_FaultRate()
	 * @model default="0.1"
	 * @generated
	 */
	double getFaultRate();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.PowerDeliveryElement#getFaultRate <em>Fault Rate</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getPowerDeliveryElement_PctPerm()
	 * @model default="20.0"
	 * @generated
	 */
	double getPctPerm();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.PowerDeliveryElement#getPctPerm <em>Pct Perm</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setRepair(int)
	 * @see dss.delivery.DeliveryPackage#getPowerDeliveryElement_Repair()
	 * @model default="3"
	 * @generated
	 */
	int getRepair();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.PowerDeliveryElement#getRepair <em>Repair</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
