 ...
 * <ul>
 *   <li>{@link dss.delivery.impl.FaultImpl#getBus1 <em>Bus1</em>}</li>
 *   <li>{@link dss.delivery.impl.FaultImpl#getBus2 <em>Bus2</em>}</li>
 *   <li>{@link dss.delivery.impl.FaultImpl#getR <em>R</em>}</li>
 *   <li>{@link dss.delivery.impl.FaultImpl#getPctStdDev <em>Pct Std Dev</em>}</li>
 *   <li>{@link dss.delivery.impl.FaultImpl#getGMatrix <em>GMatrix</em>}</li>
 *   <li>{@link dss.delivery.impl.FaultImpl#getOnTime <em>On Time</em>}</li>
 *   <li>{@link dss.delivery.impl.FaultImpl#isTemporary <em>Temporary</em>}</li>
 *   <li>{@link dss.delivery.impl.FaultImpl#getMinAmps <em>Min Amps</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FaultImpl extends PowerDeliveryElementImpl implements Fault {
	...
	/**
	 * The default value of the '{@link #getGMatrix() <em>GMatrix</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getGMatrix()
	 * @generated
	 * @ordered
	 */
	protected static final DenseDoubleMatrix2D GMATRIX_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getGMatrix() <em>GMatrix</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getGMatrix()
	 * @generated
	 * @ordered
	 */
	protected DenseDoubleMatrix2D gMatrix = GMATRIX_EDEFAULT;
	 ...
	 * @generated
	 */
	public DenseDoubleMatrix2D getGMatrix() {
		return gMatrix;
	}
	 ...
	 * @generated
	 */
	public void setGMatrix(DenseDoubleMatrix2D newGMatrix) {
		DenseDoubleMatrix2D oldGMatrix = gMatrix;
		gMatrix = newGMatrix;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case DeliveryPackage.FAULT__PCT_STD_DEV:
				...
				return;
			case DeliveryPackage.FAULT__GMATRIX:
				setGMatrix((DenseDoubleMatrix2D)newValue);
				return;
			case DeliveryPackage.FAULT__ON_TIME:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case DeliveryPackage.FAULT__GMATRIX:
				return GMATRIX_EDEFAULT == null ? gMatrix != null : !GMATRIX_EDEFAULT.equals(gMatrix);
			case DeliveryPackage.FAULT__ON_TIME:
