 ...
 * <ul>
 *   <li>{@link dss.delivery.impl.FuseImpl#getMonitoredObj <em>Monitored Obj</em>}</li>
 *   <li>{@link dss.delivery.impl.FuseImpl#getMonitorTerm <em>Monitor Term</em>}</li>
 *   <li>{@link dss.delivery.impl.FuseImpl#getSwitchedObj <em>Switched Obj</em>}</li>
 *   <li>{@link dss.delivery.impl.FuseImpl#getSwitchedTerm <em>Switched Term</em>}</li>
 *   <li>{@link dss.delivery.impl.FuseImpl#getFuseCurve <em>Fuse Curve</em>}</li>
 *   <li>{@link dss.delivery.impl.FuseImpl#getRatedCurrent <em>Rated Current</em>}</li>
 *   <li>{@link dss.delivery.impl.FuseImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link dss.delivery.impl.FuseImpl#getAction <em>Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
