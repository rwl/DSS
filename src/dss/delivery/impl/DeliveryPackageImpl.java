...
public class DeliveryPackageImpl extends EPackageImpl implements DeliveryPackage {
	 ...
	 * @see dss.delivery.DeliveryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getCapacitor_CMatrix() {
		return (EAttribute)capacitorEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getFault_GMatrix() {
		return (EAttribute)faultEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLine_RMatrix() {
	 ...
	 * @generated
	 */
	public EAttribute getLine_XMatrix() {
	 ...
	 * @generated
	 */
	public EAttribute getLine_CMatrix() {
	 ...
	 * @generated
	 */
	public EAttribute getReactor_RMatrix() {
		return (EAttribute)reactorEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 * @generated
	 */
	public EAttribute getReactor_XMatrix() {
		return (EAttribute)reactorEClass.getEStructuralFeatures().get(6);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(capacitorEClass, CAPACITOR__CMATRIX);
		...
		createEAttribute(faultEClass, FAULT__GMATRIX);
		...
		createEAttribute(lineEClass, LINE__RMATRIX);
		createEAttribute(lineEClass, LINE__XMATRIX);
		createEAttribute(lineEClass, LINE__CMATRIX);
		...
		createEAttribute(reactorEClass, REACTOR__RMATRIX);
		createEAttribute(reactorEClass, REACTOR__XMATRIX);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCapacitor_CMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "cMatrix", null, 0, 1, Capacitor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFault_GMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "gMatrix", null, 0, 1, Fault.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLine_RMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "rMatrix", null, 0, 1, Line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLine_XMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "xMatrix", null, 0, 1, Line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLine_CMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "cMatrix", null, 0, 1, Line.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getReactor_RMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "rMatrix", null, 0, 1, Reactor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getReactor_XMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "xMatrix", null, 0, 1, Reactor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
