 ...
 * <ul>
 *   <li>{@link dss.delivery.Capacitor#getBus1 <em>Bus1</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getBus2 <em>Bus2</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getKVAr <em>KV Ar</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getKV <em>KV</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getConn <em>Conn</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getCMatrix <em>CMatrix</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getCuf <em>Cuf</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getR <em>R</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getXl <em>Xl</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getHarm <em>Harm</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getNSteps <em>NSteps</em>}</li>
 *   <li>{@link dss.delivery.Capacitor#getStates <em>States</em>}</li>
 * </ul>
 * </p>
 *
 * @see dss.delivery.DeliveryPackage#getCapacitor()
 * @model
 * @generated
 */
public interface Capacitor extends PowerDeliveryElement {
	 ...
	 * @see #setBus1(String)
	 * @see dss.delivery.DeliveryPackage#getCapacitor_Bus1()
	 * @model
	 * @generated
	 */
	String getBus1();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Capacitor#getBus1 <em>Bus1</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setBus2(String)
	 * @see dss.delivery.DeliveryPackage#getCapacitor_Bus2()
	 * @model
	 * @generated
	 */
	String getBus2();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Capacitor#getBus2 <em>Bus2</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setKVAr(double)
	 * @see dss.delivery.DeliveryPackage#getCapacitor_KVAr()
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Capacitor#getKVAr <em>KV Ar</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setKV(double)
	 * @see dss.delivery.DeliveryPackage#getCapacitor_KV()
	 * @model default="12.47"
	 * @generated
	 */
	double getKV();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Capacitor#getKV <em>KV</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getCapacitor_Conn()
	 * @model default="Wye"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Capacitor#getConn <em>Conn</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getCapacitor_CMatrix()
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Capacitor#getCMatrix <em>CMatrix</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getCapacitor_Cuf()
	 * @model
	 * @generated
	 */
	EList<Double> getCuf();
	 ...
	 * @see dss.delivery.DeliveryPackage#getCapacitor_R()
	 * @model
	 * @generated
	 */
	EList<Double> getR();
	 ...
	 * @see dss.delivery.DeliveryPackage#getCapacitor_Xl()
	 * @model
	 * @generated
	 */
	EList<Double> getXl();
	 ...
	 * @see dss.delivery.DeliveryPackage#getCapacitor_Harm()
	 * @model
	 * @generated
	 */
	 ...
	 * @see #setNSteps(int)
	 * @see dss.delivery.DeliveryPackage#getCapacitor_NSteps()
	 * @model default="1"
	 * @generated
	 */
	int getNSteps();
	...
	/**
	 * Sets the value of the '{@link dss.delivery.Capacitor#getNSteps <em>NSteps</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.delivery.DeliveryPackage#getCapacitor_States()
	 * @model
	 * @generated
	 */
