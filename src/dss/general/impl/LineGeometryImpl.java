 ...
 * <ul>
 *   <li>{@link dss.general.impl.LineGeometryImpl#getNConds <em>NConds</em>}</li>
 *   <li>{@link dss.general.impl.LineGeometryImpl#getNPhases <em>NPhases</em>}</li>
 *   <li>{@link dss.general.impl.LineGeometryImpl#getCond <em>Cond</em>}</li>
 *   <li>{@link dss.general.impl.LineGeometryImpl#getWire <em>Wire</em>}</li>
 *   <li>{@link dss.general.impl.LineGeometryImpl#getX <em>X</em>}</li>
 *   <li>{@link dss.general.impl.LineGeometryImpl#getH <em>H</em>}</li>
 *   <li>{@link dss.general.impl.LineGeometryImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link dss.general.impl.LineGeometryImpl#getNormAmps <em>Norm Amps</em>}</li>
 *   <li>{@link dss.general.impl.LineGeometryImpl#getEmergAmps <em>Emerg Amps</em>}</li>
 *   <li>{@link dss.general.impl.LineGeometryImpl#isReduce <em>Reduce</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
