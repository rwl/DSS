 ...
 * <ul>
 *   <li>{@link dss.general.impl.LineCodeImpl#getNPhases <em>NPhases</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getR1 <em>R1</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getX1 <em>X1</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getX0 <em>X0</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getC1 <em>C1</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getC0 <em>C0</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getUnits <em>Units</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getRMatrix <em>RMatrix</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getXMatrix <em>XMatrix</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getCMatrix <em>CMatrix</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getBaseFreq <em>Base Freq</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getNormAmps <em>Norm Amps</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getEmergAmps <em>Emerg Amps</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getFaultRate <em>Fault Rate</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getPctPerm <em>Pct Perm</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getRepair <em>Repair</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#isKron <em>Kron</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getRg <em>Rg</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getXg <em>Xg</em>}</li>
 *   <li>{@link dss.general.impl.LineCodeImpl#getRho <em>Rho</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
