 ...
 * <ul>
 *   <li>{@link dss.general.impl.WireDataImpl#getRDC <em>RDC</em>}</li>
 *   <li>{@link dss.general.impl.WireDataImpl#getRAC <em>RAC</em>}</li>
 *   <li>{@link dss.general.impl.WireDataImpl#getRUnits <em>RUnits</em>}</li>
 *   <li>{@link dss.general.impl.WireDataImpl#getGmrAC <em>Gmr AC</em>}</li>
 *   <li>{@link dss.general.impl.WireDataImpl#getGmrUnits <em>Gmr Units</em>}</li>
 *   <li>{@link dss.general.impl.WireDataImpl#getRadius <em>Radius</em>}</li>
 *   <li>{@link dss.general.impl.WireDataImpl#getRadUnits <em>Rad Units</em>}</li>
 *   <li>{@link dss.general.impl.WireDataImpl#getNormAmps <em>Norm Amps</em>}</li>
 *   <li>{@link dss.general.impl.WireDataImpl#getEmergAmps <em>Emerg Amps</em>}</li>
 *   <li>{@link dss.general.impl.WireDataImpl#getDiameter <em>Diameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
