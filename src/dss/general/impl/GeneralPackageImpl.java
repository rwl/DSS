...
public class GeneralPackageImpl extends EPackageImpl implements GeneralPackage {
	 ...
	 * @see dss.general.GeneralPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getLineCode_RMatrix() {
	 ...
	 * @generated
	 */
	public EAttribute getLineCode_XMatrix() {
		return (EAttribute)lineCodeEClass.getEStructuralFeatures().get(8);
	}
	 ...
	 * @generated
	 */
	public EAttribute getLineCode_CMatrix() {
		return (EAttribute)lineCodeEClass.getEStructuralFeatures().get(9);
	}
	...
	public EAttribute getLineCode_BaseFreq() {
		return (EAttribute)lineCodeEClass.getEStructuralFeatures().get(10);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(lineCodeEClass, LINE_CODE__RMATRIX);
		createEAttribute(lineCodeEClass, LINE_CODE__XMATRIX);
		createEAttribute(lineCodeEClass, LINE_CODE__CMATRIX);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getLineCode_X0(), ecorePackage.getEDouble(), "x0", "0.4047", 0, 1, LineCode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getLineCode_RMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "rMatrix", null, 0, 1, LineCode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLineCode_XMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "xMatrix", null, 0, 1, LineCode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLineCode_CMatrix(), theDSSPackage.getDenseDoubleMatrix2D(), "cMatrix", null, 0, 1, LineCode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
