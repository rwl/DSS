 ...
 * <ul>
 *   <li>{@link dss.common.impl.CircuitImpl#getSolution <em>Solution</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getControlQueue <em>Control Queue</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getBusList <em>Bus List</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getFaults <em>Faults</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getVoltageSources <em>Voltage Sources</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getCurrentSources <em>Current Sources</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getSensors <em>Sensors</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getMonitors <em>Monitors</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getEnergyMeters <em>Energy Meters</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getGenerators <em>Generators</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getTransformers <em>Transformers</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getCapControls <em>Cap Controls</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getRegControls <em>Reg Controls</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getLines <em>Lines</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getLoads <em>Loads</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getShuntCapacitors <em>Shunt Capacitors</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getFeeder <em>Feeder</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getName <em>Name</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getNumNodes <em>Num Nodes</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getGeneratorDispatchReference <em>Generator Dispatch Reference</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getGenMultiplier <em>Gen Multiplier</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#isSolved <em>Solved</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#isBusNameRedefined <em>Bus Name Redefined</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#isControl_busNameRedefined <em>Control bus Name Redefined</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getLoadMultiplier <em>Load Multiplier</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getDefaultGrowthFactor <em>Default Growth Factor</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getDefaultHourMult <em>Default Hour Mult</em>}</li>
 *   <li>{@link dss.common.impl.CircuitImpl#getPriceSignal <em>Price Signal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
    ...
    public void buildYMatrix(yBuildOption buildOption, boolean allocateVI) {
        ...
        for (int i = 0; i < getCircuitElements().size(); i++) {
            ...
            if (element.isEnabled()) {
                SparseDComplexMatrix2D yPrimValues = element.getYPrimValues(buildOption);
