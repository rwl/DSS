...
public class CommonPackageImpl extends EPackageImpl implements CommonPackage {
	 ...
	 * @see dss.common.CommonPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
    public EAttribute getCircuitElement_YPrimSeries() {
		return (EAttribute)circuitElementEClass.getEStructuralFeatures().get(19);
	}
	 ...
	 * @generated
	 */
    public EAttribute getCircuitElement_YPrimShunt() {
		return (EAttribute)circuitElementEClass.getEStructuralFeatures().get(20);
	}
	 ...
	 * @generated
	 */
    public EAttribute getCircuitElement_YPrim() {
		return (EAttribute)circuitElementEClass.getEStructuralFeatures().get(21);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSolution_NodeV() {
	 ...
	 * @generated
	 */
	public EAttribute getSolution_Currents() {
    ...
    public void createPackageContents() {
		...
		createEAttribute(circuitElementEClass, CIRCUIT_ELEMENT__YPRIM_SERIES);
		createEAttribute(circuitElementEClass, CIRCUIT_ELEMENT__YPRIM_SHUNT);
		createEAttribute(circuitElementEClass, CIRCUIT_ELEMENT__YPRIM);
		...
		createEAttribute(solutionEClass, SOLUTION__NODE_V);
		createEAttribute(solutionEClass, SOLUTION__CURRENTS);
    ...
    public void initializePackageContents() {
		...
		DSSPackage theDSSPackage = (DSSPackage)EPackage.Registry.INSTANCE.getEPackage(DSSPackage.eNS_URI);
		...
		initEReference(getCircuit_ControlQueue(), this.getControlQueue(), null, "controlQueue", null, 1, 1, Circuit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCircuitElement_YPrimSeries(), theDSSPackage.getSparseDComplexMatrix2D(), "yPrimSeries", null, 0, 1, CircuitElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCircuitElement_YPrimShunt(), theDSSPackage.getSparseDComplexMatrix2D(), "yPrimShunt", null, 0, 1, CircuitElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCircuitElement_YPrim(), theDSSPackage.getSparseDComplexMatrix2D(), "yPrim", null, 0, 1, CircuitElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEParameter(op, theDSSPackage.getSparseDComplexMatrix2D(), "yMatrix", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(circuitElementEClass, theDSSPackage.getSparseDComplexMatrix2D(), "getYPrimValues", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getSolution_NodeV(), theDSSPackage.getDenseDComplexMatrix1D(), "nodeV", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSolution_Currents(), theDSSPackage.getDenseDComplexMatrix1D(), "currents", null, 0, 1, Solution.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEParameter(op, theDSSPackage.getDenseDComplexMatrix1D(), "v", 0, 1, IS_UNIQUE, IS_ORDERED);
