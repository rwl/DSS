 ...
 * <ul>
 *   <li>{@link dss.conversion.CurrentSource#getBus1 <em>Bus1</em>}</li>
 *   <li>{@link dss.conversion.CurrentSource#getAmps <em>Amps</em>}</li>
 *   <li>{@link dss.conversion.CurrentSource#getAngle <em>Angle</em>}</li>
 *   <li>{@link dss.conversion.CurrentSource#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link dss.conversion.CurrentSource#getPhases <em>Phases</em>}</li>
 *   <li>{@link dss.conversion.CurrentSource#getScanType <em>Scan Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see dss.conversion.ConversionPackage#getCurrentSource()
 * @model
 * @generated
 */
public interface CurrentSource extends PowerConversionElement {
	 ...
	 * @see #setBus1(String)
	 * @see dss.conversion.ConversionPackage#getCurrentSource_Bus1()
	 * @model
	 * @generated
	 */
	String getBus1();
	...
	/**
	 * Sets the value of the '{@link dss.conversion.CurrentSource#getBus1 <em>Bus1</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setAmps(double)
	 * @see dss.conversion.ConversionPackage#getCurrentSource_Amps()
	 * @model
	 * @generated
	 */
	double getAmps();
	...
	/**
	 * Sets the value of the '{@link dss.conversion.CurrentSource#getAmps <em>Amps</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setAngle(double)
	 * @see dss.conversion.ConversionPackage#getCurrentSource_Angle()
	 * @model
	 * @generated
	 */
	double getAngle();
	...
	/**
	 * Sets the value of the '{@link dss.conversion.CurrentSource#getAngle <em>Angle</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.conversion.ConversionPackage#getCurrentSource_Frequency()
	 * @model default="60.0"
	 * @generated
	 */
	double getFrequency();
	...
	/**
	 * Sets the value of the '{@link dss.conversion.CurrentSource#getFrequency <em>Frequency</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setPhases(int)
	 * @see dss.conversion.ConversionPackage#getCurrentSource_Phases()
	 * @model
	 * @generated
	 */
	int getPhases();
	...
	/**
	 * Sets the value of the '{@link dss.conversion.CurrentSource#getPhases <em>Phases</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.conversion.ConversionPackage#getCurrentSource_ScanType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dss.conversion.CurrentSource#getScanType <em>Scan Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
