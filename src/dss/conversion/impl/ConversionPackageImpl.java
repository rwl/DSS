...
import dss.conversion.Equivalent;
...
import dss.conversion.loadModel;
import dss.conversion.loadSpecType;
import dss.conversion.loadStatus;
...
public class ConversionPackageImpl extends EPackageImpl implements ConversionPackage {
	 ...
	 * @see dss.conversion.ConversionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getVoltageSource_Z() {
		return (EAttribute)voltageSourceEClass.getEStructuralFeatures().get(16);
	}
	 ...
	 * @generated
	 */
	public EAttribute getVoltageSource_ZInv() {
		return (EAttribute)voltageSourceEClass.getEStructuralFeatures().get(17);
	}
    ...
    public void createPackageContents() {
		...
		createEAttribute(voltageSourceEClass, VOLTAGE_SOURCE__Z);
		createEAttribute(voltageSourceEClass, VOLTAGE_SOURCE__ZINV);
    ...
    public void initializePackageContents() {
		...
		addEParameter(op, theDSSPackage.getDenseDComplexMatrix1D(), "curr", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getGenerator_ShapeFactor(), theDSSPackage.getComplex(), "shapeFactor", null, 0, 1, Generator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGenerator_YEq(), theDSSPackage.getComplex(), "yEq", null, 0, 1, Generator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGenerator_YEq95(), theDSSPackage.getComplex(), "yEq95", null, 0, 1, Generator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getGenerator_YEq105(), theDSSPackage.getComplex(), "yEq105", null, 0, 1, Generator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVoltageSource_Z(), theDSSPackage.getSparseDComplexMatrix2D(), "z", null, 0, 1, VoltageSource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVoltageSource_ZInv(), theDSSPackage.getSparseDComplexMatrix2D(), "zInv", null, 0, 1, VoltageSource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
