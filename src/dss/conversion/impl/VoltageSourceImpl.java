...
import dss.conversion.sequenceType;
import dss.conversion.specType;
 ...
 * <ul>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getBus1 <em>Bus1</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getBaseKV <em>Base KV</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getPerUnit <em>Per Unit</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getAngle <em>Angle</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getMvaSC3 <em>Mva SC3</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getMvaSC1 <em>Mva SC1</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getX1R1 <em>X1R1</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getX0R0 <em>X0R0</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getISC3 <em>ISC3</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getISC1 <em>ISC1</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getR1 <em>R1</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getX1 <em>X1</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getR0 <em>R0</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getX0 <em>X0</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getScanType <em>Scan Type</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getZ <em>Z</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getZInv <em>ZInv</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getZSpecType <em>ZSpec Type</em>}</li>
 *   <li>{@link dss.conversion.impl.VoltageSourceImpl#getVMag <em>VMag</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VoltageSourceImpl extends PowerConversionElementImpl implements VoltageSource {
	 ...
	 * @ordered
	 */
    protected static final SparseDComplexMatrix2D Z_EDEFAULT = null;
	 ...
	 * @ordered
	 */
    protected SparseDComplexMatrix2D z = Z_EDEFAULT;

                /**
	 * The default value of the '{@link #getZInv() <em>ZInv</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @see #getZInv()
	 * @generated
	 * @ordered
	 */
    protected static final SparseDComplexMatrix2D ZINV_EDEFAULT = null;

                /**
	 * The cached value of the '{@link #getZInv() <em>ZInv</em>}' attribute.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @see #getZInv()
	 * @generated
	 * @ordered
	 */
    protected SparseDComplexMatrix2D zInv = ZINV_EDEFAULT;
	 ...
	 * @generated
	 */
    public SparseDComplexMatrix2D getZ() {
		return z;
	}
	 ...
	 * @generated
	 */
    public void setZ(SparseDComplexMatrix2D newZ) {
		SparseDComplexMatrix2D oldZ = z;
		z = newZ;
		if (eNotificationRequired())
	 ...
	 * @generated
	 */
    public SparseDComplexMatrix2D getZInv() {
		return zInv;
	}
	 ...
	 * @generated
	 */
    public void setZInv(SparseDComplexMatrix2D newZInv) {
		SparseDComplexMatrix2D oldZInv = zInv;
		zInv = newZInv;
		if (eNotificationRequired())
    ...
    public void recalcElementData() {
        setZ((SparseDComplexMatrix2D) DComplexFactory2D.sparse.make(getNPhases(), getNPhases()));
        setZInv((SparseDComplexMatrix2D) DComplexFactory2D.sparse.make(getNPhases(), getNPhases()));
    ...
    public void calcYPrim(double yPrimFreq) {
        if (isYPrimInvalid()) {
            ...
            if (getYPrim() == null) {
                setYPrim((SparseDComplexMatrix2D) DComplexFactory2D.sparse.make(getNTerms(), getNConds()));
            } else {
        ...
        setYPrim((SparseDComplexMatrix2D) getYPrimSeries().copy());
    ...
    public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ConversionPackage.VOLTAGE_SOURCE__SCAN_TYPE:
				...
				return;
			case ConversionPackage.VOLTAGE_SOURCE__Z:
				setZ((SparseDComplexMatrix2D)newValue);
				return;
			case ConversionPackage.VOLTAGE_SOURCE__ZINV:
				setZInv((SparseDComplexMatrix2D)newValue);
				return;
			case ConversionPackage.VOLTAGE_SOURCE__ZSPEC_TYPE:
    ...
    public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ConversionPackage.VOLTAGE_SOURCE__ZINV:
				return ZINV_EDEFAULT == null ? zInv != null : !ZINV_EDEFAULT.equals(zInv);
			case ConversionPackage.VOLTAGE_SOURCE__ZSPEC_TYPE:
