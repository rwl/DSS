...
import dss.conversion.dispatchType;
import dss.conversion.generatorModel;
import dss.conversion.generatorStatus;
 ...
 * <ul>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getCircuit <em>Circuit</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getBus1 <em>Bus1</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getKV <em>KV</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getKW <em>KW</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getPf <em>Pf</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getKVAr <em>KV Ar</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getModel <em>Model</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVMinPU <em>VMin PU</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVMaxPU <em>VMax PU</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getYearly <em>Yearly</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getDaily <em>Daily</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getDuty <em>Duty</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getDispMode <em>Disp Mode</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getDispValue <em>Disp Value</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getConn <em>Conn</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getRNeut <em>RNeut</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getXNeut <em>XNeut</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVPU <em>VPU</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVTarget <em>VTarget</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getMaxKVAr <em>Max KV Ar</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getMinKVAr <em>Min KV Ar</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getPvFactor <em>Pv Factor</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#isForceOn <em>Force On</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getKVA <em>KVA</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getMVA <em>MVA</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getXD <em>XD</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getXDp <em>XDp</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getXDpp <em>XDpp</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getH <em>H</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getD <em>D</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getUserModel <em>User Model</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getUserData <em>User Data</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getShaftModel <em>Shaft Model</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getShaftData <em>Shaft Data</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#isDebugTrace <em>Debug Trace</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#isGenOn <em>Gen On</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getShapeFactor <em>Shape Factor</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#isForcedOn <em>Forced On</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#isFixed <em>Fixed</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getYEq <em>YEq</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getYEq95 <em>YEq95</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getYEq105 <em>YEq105</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVBase <em>VBase</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVBase95 <em>VBase95</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVBase105 <em>VBase105</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVarBase <em>Var Base</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVarMin <em>Var Min</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getVarMax <em>Var Max</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getDeltaQMax <em>Delta QMax</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getDQdV <em>DQd V</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getDQdVSaved <em>DQd VSaved</em>}</li>
 *   <li>{@link dss.conversion.impl.GeneratorImpl#getYQFixed <em>YQ Fixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneratorImpl extends PowerConversionElementImpl implements Generator {
     ...
     * @param yMatrix
     */
    public void calcYPrimMatrix(SparseDComplexMatrix2D yMatrix) {
        ...
        if (getCircuit().getSolution().isDynamicModel() || getCircuit().getSolution().isHarmonicModel()) {
            ...
            for (int i = 0; i < getNPhases(); i++) {
                switch (getConn()) {
                    case LN:
                        yMatrix.setQuick(i, i, Y);
                        yMatrix.setQuick(getNConds(), getNConds(),
                                yMatrix.getRealPart().getQuick(getNConds(), getNConds()) + Y[0],
                                yMatrix.getImaginaryPart().getQuick(getNConds(), getNConds()) + Y[1]);
                        yMatrix.setQuick(i, getNConds(), Yij);
                        if (i != getNConds())
                            yMatrix.setQuick(getNConds(), i, Yij);
                    case DELTA:
                        yMatrix.setQuick(i, i, Y);
                        yMatrix.setQuick(i, i,
                                yMatrix.getRealPart().getQuick(i, i) + Y[0],
                                yMatrix.getImaginaryPart().getQuick(i, i) + Y[1]);
                        for (int j = 0; j < i-1; j++) {
                            yMatrix.setQuick(i, j, Yij);
                            if (i != j)
                                yMatrix.setQuick(j, i, Yij);
                        }
                }
            }
        } else {
            ...
            switch (getConn()) {
                case WYE:
                    ...
                    for (int i = 0; i < getNPhases(); i++) {
                        yMatrix.setQuick(i, i, Y);
                        yMatrix.setQuick(getNConds(), getNConds(),
                                DComplexFunctions.plus.apply(yMatrix.getQuick(getNConds(), getNConds()), Y));
                        yMatrix.setQuick(i, getNConds(), Yij);
                        if (i != getNConds())
                            yMatrix.setQuick(getNConds(), i, Yij);
                    }
                case DELTA:
                    ...
                    for (int i = 0; i < getNPhases(); i++) {
                        ...
                        if (j > getNConds())
                            ...
                            j = 1;
                        yMatrix.setQuick(i, i, DComplexFunctions.plus.apply(yMatrix.getQuick(i, i), Y));
                        yMatrix.setQuick(j, j, DComplexFunctions.plus.apply(yMatrix.getQuick(j, j), Y));

                        yMatrix.setQuick(i, j, DComplexFunctions.plus.apply(yMatrix.getQuick(i, j), Yij));
                        if (i != j)
                            yMatrix.setQuick(j, i, DComplexFunctions.plus.apply(yMatrix.getQuick(j, i), Yij));
                    }
            }
        }
    }
    ...
    public void calcYPrim() {
        ...
        setYPrimShunt((SparseDComplexMatrix2D) DComplexFactory2D.sparse.make(yOrder, yOrder));
        setYPrimSeries((SparseDComplexMatrix2D) DComplexFactory2D.sparse.make(yOrder, yOrder));
        setYPrim((SparseDComplexMatrix2D) DComplexFactory2D.sparse.make(yOrder, yOrder));
        ...
        setYPrim((SparseDComplexMatrix2D) getYPrimShunt().copy());
