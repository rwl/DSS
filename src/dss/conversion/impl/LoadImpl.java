 ...
 * <ul>
 *   <li>{@link dss.conversion.impl.LoadImpl#getCircuit <em>Circuit</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getGrowthShapeObj <em>Growth Shape Obj</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getBus1 <em>Bus1</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getKV <em>KV</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getKW <em>KW</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getKVAr <em>KV Ar</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getPF <em>PF</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getModel <em>Model</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getLoadSpec <em>Load Spec</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getYearly <em>Yearly</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getDaily <em>Daily</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getDuty <em>Duty</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getGrowth <em>Growth</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getConn <em>Conn</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getRNeut <em>RNeut</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getXNeut <em>XNeut</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getClass_ <em>Class</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getVMinPU <em>VMin PU</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getVMaxPU <em>VMax PU</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getVMinNorm <em>VMin Norm</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getVMinEmerg <em>VMin Emerg</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getXfKVA <em>Xf KVA</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getAllocationFactor <em>Allocation Factor</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getKVA <em>KVA</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getPctMean <em>Pct Mean</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getPctStdDev <em>Pct Std Dev</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getCvrWatts <em>Cvr Watts</em>}</li>
 *   <li>{@link dss.conversion.impl.LoadImpl#getCvrVars <em>Cvr Vars</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
