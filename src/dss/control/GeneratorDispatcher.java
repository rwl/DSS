 ...
 * <ul>
 *   <li>{@link dss.control.GeneratorDispatcher#getElement <em>Element</em>}</li>
 *   <li>{@link dss.control.GeneratorDispatcher#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link dss.control.GeneratorDispatcher#getKWLimit <em>KW Limit</em>}</li>
 *   <li>{@link dss.control.GeneratorDispatcher#getKWBand <em>KW Band</em>}</li>
 *   <li>{@link dss.control.GeneratorDispatcher#getKVarLimit <em>KVar Limit</em>}</li>
 *   <li>{@link dss.control.GeneratorDispatcher#getGenList <em>Gen List</em>}</li>
 *   <li>{@link dss.control.GeneratorDispatcher#getWeights <em>Weights</em>}</li>
 * </ul>
 * </p>
 *
 * @see dss.control.ControlPackage#getGeneratorDispatcher()
 * @model
 * @generated
 */
public interface GeneratorDispatcher extends ControlElement {
	 ...
	 * @see dss.control.ControlPackage#getGeneratorDispatcher_Element()
	 * @model
	 * @generated
	 */
	String getElement();
	...
	/**
	 * Sets the value of the '{@link dss.control.GeneratorDispatcher#getElement <em>Element</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTerminal(int)
	 * @see dss.control.ControlPackage#getGeneratorDispatcher_Terminal()
	 * @model default="1"
	 * @generated
	 */
	int getTerminal();
	...
	/**
	 * Sets the value of the '{@link dss.control.GeneratorDispatcher#getTerminal <em>Terminal</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.control.ControlPackage#getGeneratorDispatcher_KWLimit()
	...
	/**
	 * Sets the value of the '{@link dss.control.GeneratorDispatcher#getKWLimit <em>KW Limit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.control.ControlPackage#getGeneratorDispatcher_KWBand()
	 * @model default="100.0"
	 * @generated
	 */
	double getKWBand();
	...
	/**
	 * Sets the value of the '{@link dss.control.GeneratorDispatcher#getKWBand <em>KW Band</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.control.ControlPackage#getGeneratorDispatcher_KVarLimit()
	 * @model
	 * @generated
	 */
	double getKVarLimit();
	...
	/**
	 * Sets the value of the '{@link dss.control.GeneratorDispatcher#getKVarLimit <em>KVar Limit</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.control.ControlPackage#getGeneratorDispatcher_GenList()
	 * @model
	 * @generated
	 */
	 ...
	 * @see dss.control.ControlPackage#getGeneratorDispatcher_Weights()
	 * @model
	 * @generated
	 */
