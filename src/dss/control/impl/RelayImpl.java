...
import dss.control.Relay;
import dss.control.relayType;
 ...
 * <ul>
 *   <li>{@link dss.control.impl.RelayImpl#getMonitoredObj <em>Monitored Obj</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getMonitoredTerm <em>Monitored Term</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getSwitchedObj <em>Switched Obj</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getSwitchedTerm <em>Switched Term</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getType <em>Type</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getPhaseCurve <em>Phase Curve</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getGroundCurve <em>Ground Curve</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getPhaseTrip <em>Phase Trip</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getGroundTrip <em>Ground Trip</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getTDPhase <em>TD Phase</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getTDGround <em>TD Ground</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getPhaseInst <em>Phase Inst</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getGroundInst <em>Ground Inst</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getReset <em>Reset</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getShots <em>Shots</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getRecloseIntervals <em>Reclose Intervals</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getOvervoltCurve <em>Overvolt Curve</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getUndervoltCurve <em>Undervolt Curve</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getKVBase <em>KV Base</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getPctPickup47 <em>Pct Pickup47</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getPctAmps46 <em>Pct Amps46</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getPctPickup46 <em>Pct Pickup46</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getISQT46 <em>ISQT46</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getVariable <em>Variable</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getOvertrip <em>Overtrip</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getUndertrip <em>Undertrip</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getBreakerTime <em>Breaker Time</em>}</li>
 *   <li>{@link dss.control.impl.RelayImpl#getAction <em>Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
