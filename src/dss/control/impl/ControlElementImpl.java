 ...
 * <ul>
 *   <li>{@link dss.control.impl.ControlElementImpl#getElementName <em>Element Name</em>}</li>
 *   <li>{@link dss.control.impl.ControlElementImpl#getElementTerminal <em>Element Terminal</em>}</li>
 *   <li>{@link dss.control.impl.ControlElementImpl#getControlledBusName <em>Controlled Bus Name</em>}</li>
 *   <li>{@link dss.control.impl.ControlElementImpl#getControlledBus <em>Controlled Bus</em>}</li>
 *   <li>{@link dss.control.impl.ControlElementImpl#getMonitoredVariable <em>Monitored Variable</em>}</li>
 *   <li>{@link dss.control.impl.ControlElementImpl#getMonitoredVarIndex <em>Monitored Var Index</em>}</li>
 *   <li>{@link dss.control.impl.ControlElementImpl#getTimeDelay <em>Time Delay</em>}</li>
 *   <li>{@link dss.control.impl.ControlElementImpl#getDblTraceParam <em>Dbl Trace Param</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
