 ...
 * <ul>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getTransformer <em>Transformer</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getWinding <em>Winding</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getVReg <em>VReg</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getBand <em>Band</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getPTRatio <em>PT Ratio</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getCTPrim <em>CT Prim</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getR <em>R</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getX <em>X</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getBus <em>Bus</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#isReversible <em>Reversible</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getRevVReg <em>Rev VReg</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getRevBand <em>Rev Band</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getRevR <em>Rev R</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getRevX <em>Rev X</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getTapDelay <em>Tap Delay</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#isDebugTrace <em>Debug Trace</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getMaxTapChange <em>Max Tap Change</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#isInverseTime <em>Inverse Time</em>}</li>
 *   <li>{@link dss.control.impl.RegulatorControlImpl#getTapWinding <em>Tap Winding</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
