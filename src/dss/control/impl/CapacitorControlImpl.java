...
import dss.control.controlType;
 ...
 * <ul>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getElement <em>Element</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getCapacitor <em>Capacitor</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getType <em>Type</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getPTRatio <em>PT Ratio</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getCTRatio <em>CT Ratio</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getOnSetting <em>On Setting</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getOffSetting <em>Off Setting</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#isVoltOverride <em>Volt Override</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getVMax <em>VMax</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getVMin <em>VMin</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getDelayOff <em>Delay Off</em>}</li>
 *   <li>{@link dss.control.impl.CapacitorControlImpl#getDeadTime <em>Dead Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
