...
import dss.executive.algorithmType;
import dss.executive.autoAddType;
import dss.executive.circuitModelType;
import dss.executive.controlModeType;
import dss.executive.loadModelType;
import dss.executive.randomType;
import dss.executive.reductionStrategy;
 ...
 * <ul>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getType <em>Type</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getElement <em>Element</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getHour <em>Hour</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getSec <em>Sec</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getYear <em>Year</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getFrequency <em>Frequency</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getStepSize <em>Step Size</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getRandom <em>Random</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getTime <em>Time</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getCircuit <em>Circuit</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getEditor <em>Editor</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getTolerance <em>Tolerance</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getMaxIter <em>Max Iter</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getLoadModel <em>Load Model</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getLoadMult <em>Load Mult</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getNormVMinPU <em>Norm VMin PU</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getNormVMaxPU <em>Norm VMax PU</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getEmergVMinPU <em>Emerg VMin PU</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getEmergVMaxPU <em>Emerg VMax PU</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getPctMean <em>Pct Mean</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getPctStdDev <em>Pct Std Dev</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getLDCurve <em>LD Curve</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getPctGrowth <em>Pct Growth</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getGenKW <em>Gen KW</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getGenPF <em>Gen PF</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getCapKVAr <em>Cap KV Ar</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getAddType <em>Add Type</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isAllowDuplicates <em>Allow Duplicates</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isZoneLock <em>Zone Lock</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getUEWeight <em>UE Weight</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getLossWeight <em>Loss Weight</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getUERegs <em>UE Regs</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getLossRegs <em>Loss Regs</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getVoltageBases <em>Voltage Bases</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getAlgorithm <em>Algorithm</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isTrapezoidal <em>Trapezoidal</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getAutoBusList <em>Auto Bus List</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getControlMode <em>Control Mode</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isTraceMode <em>Trace Mode</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getGenMult <em>Gen Mult</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getDefaultDaily <em>Default Daily</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getDefaultYearly <em>Default Yearly</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getAllocationFactor <em>Allocation Factor</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getCktModel <em>Ckt Model</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getPriceSignal <em>Price Signal</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getPriceCurve <em>Price Curve</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getBaseFrequency <em>Base Frequency</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getHarmonics <em>Harmonics</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getMaxController <em>Max Controller</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getBus <em>Bus</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getDataPath <em>Data Path</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getKeepList <em>Keep List</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getReduceOption <em>Reduce Option</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isDemandInterval <em>Demand Interval</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getPctNormal <em>Pct Normal</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isDIVerbose <em>DI Verbose</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getCaseName <em>Case Name</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getMarkerCode <em>Marker Code</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#getNodeWidth <em>Node Width</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isLog <em>Log</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isRecorder <em>Recorder</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isOverloadReport <em>Overload Report</em>}</li>
 *   <li>{@link dss.executive.impl.ExecOptionsImpl#isVoltageExceptionReport <em>Voltage Exception Report</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
