 ...
 * <ul>
 *   <li>{@link dss.meter.Sensor#getElement <em>Element</em>}</li>
 *   <li>{@link dss.meter.Sensor#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link dss.meter.Sensor#getModes <em>Modes</em>}</li>
 *   <li>{@link dss.meter.Sensor#getV <em>V</em>}</li>
 *   <li>{@link dss.meter.Sensor#getI <em>I</em>}</li>
 *   <li>{@link dss.meter.Sensor#getP <em>P</em>}</li>
 *   <li>{@link dss.meter.Sensor#getQ <em>Q</em>}</li>
 *   <li>{@link dss.meter.Sensor#getPhases <em>Phases</em>}</li>
 *   <li>{@link dss.meter.Sensor#getConn <em>Conn</em>}</li>
 *   <li>{@link dss.meter.Sensor#getPctError <em>Pct Error</em>}</li>
 *   <li>{@link dss.meter.Sensor#getAction <em>Action</em>}</li>
 * </ul>
 * </p>
 *
 * @see dss.meter.MeterPackage#getSensor()
 * @model
 * @generated
 */
public interface Sensor extends MeterElement {
	 ...
	 * @see dss.meter.MeterPackage#getSensor_Element()
	 * @model
	 * @generated
	 */
	String getElement();
	...
	/**
	 * Sets the value of the '{@link dss.meter.Sensor#getElement <em>Element</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTerminal(int)
	 * @see dss.meter.MeterPackage#getSensor_Terminal()
	 * @model default="1"
	 * @generated
	 */
	int getTerminal();
	...
	/**
	 * Sets the value of the '{@link dss.meter.Sensor#getTerminal <em>Terminal</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link dss.meter.sensorMode}.
	 * The literals are from the enumeration {@link dss.meter.sensorMode}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see dss.meter.MeterPackage#getSensor_Modes()
	 * @model
	 * @generated
	 */
	 ...
	 * @see dss.meter.MeterPackage#getSensor_V()
	 * @model default="7.2"
	 * @generated
	 */
	EList<Double> getV();
	 ...
	 * @see dss.meter.MeterPackage#getSensor_I()
	 * @model
	 * @generated
	 */
	EList<Double> getI();
	 ...
	 * @see dss.meter.MeterPackage#getSensor_P()
	 * @model
	 * @generated
	 */
	EList<Double> getP();
	 ...
	 * @see dss.meter.MeterPackage#getSensor_Q()
	 * @model
	 * @generated
	 */
	EList<Double> getQ();
	 ...
	 * @see dss.meter.MeterPackage#getSensor_Phases()
	 * @model upper="3"
	 * @generated
	 */
	 ...
	 * @see dss.meter.MeterPackage#getSensor_Conn()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dss.meter.Sensor#getConn <em>Conn</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see dss.meter.MeterPackage#getSensor_PctError()
	 * @model default="1.0"
	 * @generated
	 */
	double getPctError();
	...
	/**
	 * Sets the value of the '{@link dss.meter.Sensor#getPctError <em>Pct Error</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link dss.meter.sensorAction}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see dss.meter.MeterPackage#getSensor_Action()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link dss.meter.Sensor#getAction <em>Action</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
