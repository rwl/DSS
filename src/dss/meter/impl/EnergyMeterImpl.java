 ...
 * <ul>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#getElement <em>Element</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#getAction <em>Action</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#getOption <em>Option</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#getKVANorm <em>KVA Norm</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#getKVAEmerg <em>KVA Emerg</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#getPeakCurrent <em>Peak Current</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#getZoneList <em>Zone List</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#isLocalOnly <em>Local Only</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#getMask <em>Mask</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#isLosses <em>Losses</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#isLineLosses <em>Line Losses</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#isXfmrLosses <em>Xfmr Losses</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#isSeqLosses <em>Seq Losses</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#isVBaseLosses <em>VBase Losses</em>}</li>
 *   <li>{@link dss.meter.impl.EnergyMeterImpl#isOverloadReport <em>Overload Report</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
