 ...
 * <ul>
 *   <li>{@link dss.meter.impl.MonitorImpl#getElement <em>Element</em>}</li>
 *   <li>{@link dss.meter.impl.MonitorImpl#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link dss.meter.impl.MonitorImpl#getMode <em>Mode</em>}</li>
 *   <li>{@link dss.meter.impl.MonitorImpl#getAction <em>Action</em>}</li>
 *   <li>{@link dss.meter.impl.MonitorImpl#isResidual <em>Residual</em>}</li>
 *   <li>{@link dss.meter.impl.MonitorImpl#isVIPolar <em>VI Polar</em>}</li>
 *   <li>{@link dss.meter.impl.MonitorImpl#isPPolar <em>PPolar</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
