 ...
 * <ul>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getNPts <em>NPts</em>}</li>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getInterval <em>Interval</em>}</li>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getMult <em>Mult</em>}</li>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getHour <em>Hour</em>}</li>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getMean <em>Mean</em>}</li>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getStdDev <em>Std Dev</em>}</li>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getCsvFile <em>Csv File</em>}</li>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getSngFile <em>Sng File</em>}</li>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getDblFile <em>Dbl File</em>}</li>
 *   <li>{@link electrickery.general.impl.LoadShapeImpl#getQMult <em>QMult</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
