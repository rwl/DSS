 ...
 * <ul>
 *   <li>{@link electrickery.meter.Monitor#getElement <em>Element</em>}</li>
 *   <li>{@link electrickery.meter.Monitor#getTerminal <em>Terminal</em>}</li>
 *   <li>{@link electrickery.meter.Monitor#getMode <em>Mode</em>}</li>
 *   <li>{@link electrickery.meter.Monitor#getAction <em>Action</em>}</li>
 *   <li>{@link electrickery.meter.Monitor#isResidual <em>Residual</em>}</li>
 *   <li>{@link electrickery.meter.Monitor#isVIPolar <em>VI Polar</em>}</li>
 *   <li>{@link electrickery.meter.Monitor#isPPolar <em>PPolar</em>}</li>
 * </ul>
 * </p>
 *
 * @see electrickery.meter.MeterPackage#getMonitor()
 * @model
 * @generated
 */
public interface Monitor extends MeterElement {
	 ...
	 * @see electrickery.meter.MeterPackage#getMonitor_Element()
	 * @model
	 * @generated
	 */
	String getElement();
	...
	/**
	 * Sets the value of the '{@link electrickery.meter.Monitor#getElement <em>Element</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTerminal(int)
	 * @see electrickery.meter.MeterPackage#getMonitor_Terminal()
	 * @model default="1"
	 * @generated
	 */
	int getTerminal();
	...
	/**
	 * Sets the value of the '{@link electrickery.meter.Monitor#getTerminal <em>Terminal</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link electrickery.meter.monitorValues}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see electrickery.meter.MeterPackage#getMonitor_Mode()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link electrickery.meter.Monitor#getMode <em>Mode</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link electrickery.meter.monitorAction}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see electrickery.meter.MeterPackage#getMonitor_Action()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link electrickery.meter.Monitor#getAction <em>Action</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see electrickery.meter.MeterPackage#getMonitor_Residual()
	 * @model default="false"
	 * @generated
	 */
	boolean isResidual();
	...
	/**
	 * Sets the value of the '{@link electrickery.meter.Monitor#isResidual <em>Residual</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see electrickery.meter.MeterPackage#getMonitor_VIPolar()
	 * @model default="true"
	 * @generated
	 */
	boolean isVIPolar();
	...
	/**
	 * Sets the value of the '{@link electrickery.meter.Monitor#isVIPolar <em>VI Polar</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see electrickery.meter.MeterPackage#getMonitor_PPolar()
	 * @model default="false"
	 * @generated
	 */
	boolean isPPolar();
	...
	/**
	 * Sets the value of the '{@link electrickery.meter.Monitor#isPPolar <em>PPolar</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
