 ...
 * <ul>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getWindings <em>Windings</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getWdg <em>Wdg</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getBus <em>Bus</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getConn <em>Conn</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getKV <em>KV</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getKVA <em>KVA</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getTap <em>Tap</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getRPct <em>RPct</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getRNeut <em>RNeut</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getXNeut <em>XNeut</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getBuses <em>Buses</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getConns <em>Conns</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getKVs <em>KVs</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getKVAs <em>KV As</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getTaps <em>Taps</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getXHL <em>XHL</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getXHT <em>XHT</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getXLT <em>XLT</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getXSCArray <em>XSC Array</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getThermal <em>Thermal</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getN <em>N</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getM <em>M</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getFLRise <em>FL Rise</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getHSRise <em>HS Rise</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getPctLoadLoss <em>Pct Load Loss</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getPctNoLoadLoss <em>Pct No Load Loss</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getNormHKVa <em>Norm HK Va</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getEmergHKVa <em>Emerg HK Va</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#isSubstation <em>Substation</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getMaxTap <em>Max Tap</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getMinTap <em>Min Tap</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getNumTaps <em>Num Taps</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getSubName <em>Sub Name</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getPctImage <em>Pct Image</em>}</li>
 *   <li>{@link electrickery.delivery.impl.TransformerImpl#getPpmAntiFloat <em>Ppm Anti Float</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
