...
class RegulatorControl(ControlElement):
    """A RegulatorControl is a control element that is connected to a terminal of another circuit element that must be a transformer.
    """

    def __init__(self, transformer='', winding=0, vReg=0.0, band=0.0, pTRatio=0.0, cTPrim=0.0, r=0.0, x=0.0, bus='', delay=0.0, reversible=False, revVReg=0.0, revBand=0.0, revR=0.0, revX=0.0, tapDelay=0.0, debugTrace=False, maxTapChange=0, inverseTime=False, tapWinding=0, vLimit=0.0, *args, **kw_args):
