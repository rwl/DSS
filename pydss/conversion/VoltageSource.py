...
class VoltageSource(PowerConversionElement):
    """This is a special power conversion element.  It is special because voltage sources must be identified to initialize the solution with all other injection sources set to zero.  A Vsource object is simply a multi-phase Thevenin equivalent with data specified as it would commonly be for a power system source equivalent: Line-line voltage (kV) and short circuit MVA.
    """

    def __init__(self, bus1='', baseKV=0.0, perUnit=0.0, angle=0.0, frequency=0.0, mvaSC3=0.0, mvaSC1=0.0, x1R1=0.0, x0R0=0.0, iSC3=0.0, iSC1=0.0, r1=0.0, x1=0.0, r0=0.0, x0=0.0, scanType="Positive", zSpecType="MVASc", vMag=0.0, z=None, zInv=None, *args, **kw_args):
        ...
        #: Maintain specified sequence for harmonic solution.  Default is positive sequence. Otherwise, angle between phases rotates with harmonic. Values are: "Positive", "Zero", "None"
