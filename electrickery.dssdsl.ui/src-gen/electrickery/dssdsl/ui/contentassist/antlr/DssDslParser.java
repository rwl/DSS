		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getElectrickeryAccess().getGroup_3(), "rule__Electrickery__Group_3__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_3_3(), "rule__Electrickery__Group_3_3__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_4(), "rule__Electrickery__Group_4__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_4_3(), "rule__Electrickery__Group_4_3__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_5(), "rule__Electrickery__Group_5__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_5_3(), "rule__Electrickery__Group_5_3__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_6(), "rule__Electrickery__Group_6__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_6_3(), "rule__Electrickery__Group_6_3__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_7(), "rule__Electrickery__Group_7__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_7_3(), "rule__Electrickery__Group_7_3__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_8(), "rule__Electrickery__Group_8__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_8_3(), "rule__Electrickery__Group_8_3__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_9(), "rule__Electrickery__Group_9__0");
					put(grammarAccess.getElectrickeryAccess().getGroup_9_3(), "rule__Electrickery__Group_9_3__0");
					...
					put(grammarAccess.getExecutiveAccess().getGroup_3(), "rule__Executive__Group_3__0");
					put(grammarAccess.getExecutiveAccess().getGroup_4(), "rule__Executive__Group_4__0");
					...
					put(grammarAccess.getElectrickeryAccess().getWireDataAssignment_3_2(), "rule__Electrickery__WireDataAssignment_3_2");
					put(grammarAccess.getElectrickeryAccess().getWireDataAssignment_3_3_1(), "rule__Electrickery__WireDataAssignment_3_3_1");
					put(grammarAccess.getElectrickeryAccess().getLineGeometriesAssignment_4_2(), "rule__Electrickery__LineGeometriesAssignment_4_2");
					put(grammarAccess.getElectrickeryAccess().getLineGeometriesAssignment_4_3_1(), "rule__Electrickery__LineGeometriesAssignment_4_3_1");
					put(grammarAccess.getElectrickeryAccess().getGrowthShapesAssignment_5_2(), "rule__Electrickery__GrowthShapesAssignment_5_2");
					put(grammarAccess.getElectrickeryAccess().getGrowthShapesAssignment_5_3_1(), "rule__Electrickery__GrowthShapesAssignment_5_3_1");
					put(grammarAccess.getElectrickeryAccess().getLineCodesAssignment_6_2(), "rule__Electrickery__LineCodesAssignment_6_2");
					put(grammarAccess.getElectrickeryAccess().getLineCodesAssignment_6_3_1(), "rule__Electrickery__LineCodesAssignment_6_3_1");
					put(grammarAccess.getElectrickeryAccess().getLoadShapesAssignment_7_2(), "rule__Electrickery__LoadShapesAssignment_7_2");
					put(grammarAccess.getElectrickeryAccess().getLoadShapesAssignment_7_3_1(), "rule__Electrickery__LoadShapesAssignment_7_3_1");
					put(grammarAccess.getElectrickeryAccess().getSpectrumsAssignment_8_2(), "rule__Electrickery__SpectrumsAssignment_8_2");
					put(grammarAccess.getElectrickeryAccess().getSpectrumsAssignment_8_3_1(), "rule__Electrickery__SpectrumsAssignment_8_3_1");
					put(grammarAccess.getElectrickeryAccess().getExecutivesAssignment_9_2(), "rule__Electrickery__ExecutivesAssignment_9_2");
					put(grammarAccess.getElectrickeryAccess().getExecutivesAssignment_9_3_1(), "rule__Electrickery__ExecutivesAssignment_9_3_1");
					...
					put(grammarAccess.getExecutiveAccess().getCommandAssignment_3_1(), "rule__Executive__CommandAssignment_3_1");
					put(grammarAccess.getExecutiveAccess().getMaxCircuitsAssignment_4_1(), "rule__Executive__MaxCircuitsAssignment_4_1");
